...
![example of Small Select in Data Table](images/select-usage-1.png)
...
![example of Inline Select](images/select-usage-2.png)
...
![validation on select element](images/select-usage-3.png)
